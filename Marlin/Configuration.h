...
#define STRING_CONFIG_H_AUTHOR "(Gaz Brown, SKR1.4_moons 0.9 XYE_ABL/JD/S-CURVE/BLT)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Black Bear"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200, 200, 400, 830 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -22.3, -33.9, -1.747 }
...
#define Y_MIN_POS -4
#define Z_MIN_POS 0
#define X_MAX_POS (X_BED_SIZE + 4.5)
