...
#define HOMING_BUMP_MM      { 1, 2, 2 }       // (mm) Backoff from endstops after first bump
...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_XY { {  10, 105 }, { 220,  105 } }
...
//#define LCD_SHOW_E_TOTAL
  ...
  #define EVENT_GCODE_SD_ABORT "G27 P2 \nM84 XYE"       // G-code to run on Stop Print (e.g., "G28XY" or "G27")
